package ru.samtakoy.oldlegacy.features.views.di
...
import ru.samtakoy.oldlegacy.features.views.presentation.history.mapper.ViewHistoryItemUiModelMapperImpl
...
internal fun viewsFeatureModule() = module {
    // presentation
    factory<MainTabFeatureEntry>(named<ViewsHistoryRoute>()) { ViewsHistoryEntryImpl() }
