...
internal class FavoritesViewModelImpl(
...
) : BaseViewModelImpl<FavoritesViewModel.State, FavoritesViewModel.Action, FavoritesViewModel.Event>(
    scopeProvider,
    ...
    private fun onSomeError(t: Throwable) {
        sendAction(
            FavoritesViewModel.Action.ShowErrorMessage(resources.getString(R.string.common_err_message))
        )
    }
}