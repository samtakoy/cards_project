package ru.samtakoy.oldlegacy.core.presentation.courses.select
...
import ru.samtakoy.oldlegacy.core.presentation.courses.model.CoursesAdapter.CourseClickListener
import ru.samtakoy.oldlegacy.core.presentation.courses.select.vm.SelectCourseViewModel
import ru.samtakoy.oldlegacy.core.presentation.courses.select.vm.SelectCourseViewModelImpl
...
class SelectCourseDialogFragment : AppCompatDialogFragment(), ViewModelOwner {
    ...
    private fun onAction(action: SelectCourseViewModel.Action) {
        when (action) {
            SelectCourseViewModel.Action.ExitCanceled -> exitCanceled()
            is SelectCourseViewModel.Action.ExitOk -> exitOk(action.courseId)
            is SelectCourseViewModel.Action.ShowErrorMessage -> showError(action.message)
        }
    }

    private fun onViewState(state: SelectCourseViewModel.State) {
