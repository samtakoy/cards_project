package ru.samtakoy.oldlegacy.core.presentation.online_import
...
import ru.samtakoy.oldlegacy.core.data.network.ServiceGenerator
...
class OnlineImportFragment : Fragment() {
    ...
    private val remoteFileObservable: Observable<RemoteFilesInfo>
        get() = ServiceGenerator.api.filesInfo
