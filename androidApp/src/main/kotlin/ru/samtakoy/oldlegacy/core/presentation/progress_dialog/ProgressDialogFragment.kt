package ru.samtakoy.oldlegacy.core.presentation.progress_dialog
...
import ru.samtakoy.oldlegacy.core.presentation.progress_dialog.vm.ProgressDialogViewModel
...
abstract class ProgressDialogFragment : AppCompatDialogFragment(), ViewModelOwner {
    protected abstract fun createWorkerImpl(): ProgressDialogPresenter.IProgressWorker
