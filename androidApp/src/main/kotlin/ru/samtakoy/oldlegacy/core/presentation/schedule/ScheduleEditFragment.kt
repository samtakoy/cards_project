package ru.samtakoy.oldlegacy.core.presentation.schedule
...
import ru.samtakoy.oldlegacy.core.presentation.schedule.vm.ScheduleEditViewModel
        ...
        return AlertDialog.Builder(requireActivity())
            ...
            .setPositiveButton(R.string.btn_ok, object : DialogInterface.OnClickListener {
                override fun onClick(dialogInterface: DialogInterface?, i: Int) {
                    viewModel.onEvent(ScheduleEditViewModel.Event.ConfirmResultClick)
                }
            })
            .create()
    }
    ...
    private fun initView(v: View) {
        ...
        mClearScheduleButton!!.setOnClickListener(
            View.OnClickListener { view: View? ->
                viewModel.onEvent(ScheduleEditViewModel.Event.ClearScheduleClick)
            }
        )
        ...
        mScheduleCurItemClearButton!!.setOnClickListener(
            View.OnClickListener { view: View? ->
                viewModel.onEvent(ScheduleEditViewModel.Event.ClearScheduleCurItemClick)
            }
        )
        ...
        mScheduleCurItemAddButton!!.setOnClickListener(
            View.OnClickListener { view: View? ->
                viewModel.onEvent(ScheduleEditViewModel.Event.AddScheduleCurItem)
            }
        )
        ...
        if (container.childCount < ScheduleTimeUnit.entries.size) {
            for (unit in ScheduleTimeUnit.entries) {
                ...
                unitBtn.setOnClickListener(
                    View.OnClickListener { view: View? ->
                        viewModel.onEvent(ScheduleEditViewModel.Event.ScheduleTimeUnitSelect(unit))
                    }
                )
