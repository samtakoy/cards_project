...
private fun QPackSelectionScreenInternal(
    ...
    onViewEvent: (QPackSelectionViewModel.Event) -> Unit,
    snackbarHostState: SnackbarHostState,
    modifier: Modifier = Modifier
) {
    MySimpleScreenScaffold(
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(
                    ...
                    MySelectableItem(
                        model = itemModel,
                        onClick = {
                            onViewEvent(QPackSelectionViewModel.Event.ItemClick(itemModel))
                        }
                    )
                }
            }
            MyButton(
                ...
                onClick = {
                    onViewEvent(QPackSelectionViewModel.Event.ActionButtonClick)
                },
            )
        }
    }
