...
import ru.samtakoy.core.data.local.database.DbConstKt;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.Cards;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.CardsTags;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.LearnCourse;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.QPacks;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.Tags;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.Themes;
import ru.samtakoy.core.data.local.database.old.CardsDbSchema.ThemesTags;

// больше не используется (перешли на Room), оставил для истории
public class MyDb extends SQLiteOpenHelper {

    private static final int VERSION = DbConstKt.DB_VERSION;
    private static final String DB_NAME = DbConstKt.DB_NAME;
