...
public class CardsDbSchema {
    ...
    /*
    public static final class RepeatPlan {
        public static final String NAME = "repeat_plan";
        public static class Cols {
            public static final String ID = "_id";
            public static final String CARD_IDS = "card_ids";
            public static final String TODO_CARD_IDS = "todo_card_ids";
    ...
    public static final class RepeatShedules {
        public static final String NAME = "repeat_shedules";
        public static class Cols {
